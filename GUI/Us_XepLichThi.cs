...
namespace GUI
{
    public partial class Us_XepLichThi : UserControl
    {
        ...
        {
            var listGV = new List<GiangVienDTO>()
            {
            ...
            List<LichThiXepResult> lstKqXep = xlBLL.xepLichGacThi(lstLichThi, listGV);
            int[,] ketquaxep = xlBLL.chuyenDoiXepLichSangMang(lstKqXep, listGV);
            ...
            HienThiLichThiTrenDataGridView(dgv_XepLich, ketquaxep, listGV, Uniquecolumns);
        }
